...
// matsearch(53, RedFace, OrangeFace, YellowFace, WhiteFace, GreenFace, BlueFace, temp1, temp2, temp3);
...
/*
White Edge peice follows these conditions:
- It can be in the correct spot; to solve do nothing
- The side colour can match up to the correct side; to solve rotate cw until it is in the correct spot
- The side colour can be on another surface: ex. Red white edge peice.
	- Red can be on the orange surface
	- Red can be on the yellow surface
	- Red can be on the .....
	- .... etc.
- 
